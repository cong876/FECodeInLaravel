...
<head>
    ...
    <?php
	$title = json_decode($activityData)->{'activity'}->{'activityTitle'};
	?>
	<title >{{$title}}</title>
...
<body>
	...
	<div id="content">
		<li class="item" data-id="" data-limitedNumber="">
			<section>
	...
	<!-- // <script type="text/javascript" src="{{url('js/subjectActivity.min.js')}}"></script> -->
	<script type="text/javascript" src="http://7xnzm2.com2.z0.glb.qiniucdn.com/subjectActivity.min0002.js"></script>
