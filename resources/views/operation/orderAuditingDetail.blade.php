        ...
        <div class="detail panel-body">
            <table class="ui-table-order">
                ...
                <caption class="buyerInfo">
                    ...
                    <p class="innerRight">
                        <span style="display: inline-block; float: left; color: blue">待审核</span>
                        <a class="btn btn-success btn-xs pass" role="button">通过审核</a>
                        <a class="btn btn-danger btn-xs unPass" role="button">审核不通过</a>
                    </p>
            ...
            <div class="alert alert-info" role="alert" style="margin-top: 10px">
                ...
                <p>
                    <?php if(($suborder->deliveryInfo->delivery_company_id) != 0) { ?>
                    ...
                    <a style="margin-left: 20px" target="_blank"
                       href="{{$suborder->deliveryInfo->delivery_related_url}}" role="button">审查物流</a>
                </p>
                <hr/>
                <p>
                    <span>处理人：</span>
