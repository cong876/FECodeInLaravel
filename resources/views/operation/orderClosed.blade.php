            ...
            <div class="detail panel-body">
                <table class="ui-table-order">
                    ...
                    @foreach($suborders as $suborder)
                        ...
                        if($suborder->sub_order_state == 411) {
                            $state = '买家关闭';
                        }
                        if($suborder->sub_order_state == 431) {
                            $state = '运营关闭';
                        }
                        if($suborder->sub_order_state == 441) {
                            $state = '系统关闭';
                        }
                        ...
                        <tr class="header-row">
                            <td>
                                <span style="color:blue ;font-weight:bold;"><em>NO</em>:</span><span
                                        class="order_id" style="color:blue ;font-weight:bold;">{{$suborder->sub_order_number}}</span>
