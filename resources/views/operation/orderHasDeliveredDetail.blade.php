...
@section('content')
    ...
    <div id="orderDetail">
        <div class="detail panel-body">
            <table class="ui-table-order">
                ...
                <caption class="buyerInfo">
                    ...
                    <p class="innerRight">
                        <span style="display: inline-block; float: left; color: blue">已发货<a
                                    class="btn btn-primary btn-xs sendInfo" style="margin-left: 20px" role="button">填写第二段物流</a><a
                                    class="btn btn-success btn-xs toReceive" style="margin-left: 20px">确认收货</a></span>
                    </p>
        ...
        <div id="sendInfo">
            <?php
            $second_url = 'operator/commitToOverseaDelivered/'.$suborder->sub_order_number;
            ?>
            <form role="form" method="post" action="{{url($second_url)}}">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
