...
@section('content')
    ...
    <div id="orderDetail">
        <div class="detail panel-body">
            <table class="ui-table-order">
                ...
                @foreach($items as $item)
                    ...
                    <tr class="body-row">
                        ...
                        <td class="change-cell">
                            ...
                            <?php if($suborder->sub_order_state == 541) { ?>
                            <p>
                ...
                <caption class="buyerInfo">
                    <p>
                        <span class="widthFixed">国家:<span>(原){{$suborder->country->name}}</span></span>
                        <span>邮费:<span>{{$suborder->postage}}</span></span>
                        <span class="showRight"><span>{{$number}}</span>件商品</span>
                    </p>

                    <p>
                        <span class="widthFixed">买手:<span>(原){{$suborder->seller->real_name}}</span></span>
                    ...
                    {{--<p class="innerRight">--}}
                    {{--<span style="display: inline-block; float: left; color: blue">待分配买手</span>--}}
        ...
        <!-- 查看退款记录页 -->
        <div id="refundRecord">
            <p><span>子订单号：</span><span class="suborder_number"></span></p>
            <hr/>
        ...
        <div id="refundPart">
            ...
            <form role="form" method="post" action="{{$reUrl}}">
                ...
                <div class="input-group">
                    <input type="number" name="refundItemNumber" class="form-control input-sm refundItemNumber"
                           required>
