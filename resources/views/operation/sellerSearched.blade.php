...
@section('content')
            ...
            <div class="sellerOverview panel-body">
                <table class="ui-table-order">
                    ...
                    <tr>
                        ...
                        <th>买手人数：<span class="sellerNumber">{{count($sellers)}}</span></th>
                    </tr>
                    </thead>
                    ...
                    @foreach($sellers as $seller)
                        ...
                        <tr class="body-row">
                            <td class="info-cell clearfix" rowspan="1">
                                ...
                                <p style="margin-top: 1em"><span>真实姓名：</span><span class="realname">{{$seller->real_name}}</span><br />
                                    <span>微信号：</span><span class="weixinId">{{$seller->user->wx_number}}</span></p>
                            </td>
    ...
    <nav>
        {!! $sellers->appends(Input::query())->render() !!}
    </nav>
