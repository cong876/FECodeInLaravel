...
@foreach($subOrders as $subOrder)
    ...
    <li class="order" data-item-title="{{$title_json}}" data-item-number="{{$number_json}}"
        ...
        data-item-memos="{{$memo_json}}" data-item-status="3" data-order-offer-time="{{$time_offer}}"
        data-order-pay-time="{{$time_pay}}" data-order-send-time="{{$time_delivery}}"
        data-order-audit-time="{{$time_audit}}"
        data-item-seller="{{$seller}}" data-item-seller-url="{{url('image/Australia.jpg')}}"
